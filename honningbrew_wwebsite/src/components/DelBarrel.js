...
export class DelBarrel extends Component {
    ...
    submitHandler = () => {
        ...
        fetch('http://127.0.0.1:8000/api/v1/' + this.props.match.id + '/' + this.props.match.pos, { method: 'DELETE' })
        window.history.back()
    }
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Eliminazione barile</h5>
                        </div>
                        <div className="modal-body">
                            <p className="text-normal">Vuoi davvero eliminare questo barile ?</p>
                        </div>
